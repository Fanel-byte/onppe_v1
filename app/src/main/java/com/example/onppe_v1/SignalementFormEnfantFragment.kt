...
class SignalementFormEnfantFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        signalementModel =
            ViewModelProvider(requireActivity()).get(SignalementTransfertModel::class.java)
        ...
        binding.next2.setOnClickListener { view: View ->
            if ((binding.age.text.toString().isNotEmpty()) && (binding.age.text.toString()
                    .toInt() > 17)
            ) {
                myDialog.setContentView(dialogBinding3)
                myDialog.show()
            } else {
                if ((binding.sexe.text.toString().isEmpty()) || (binding.age.text.toString()
                        .isEmpty())
                ) {
                    //affichage du pop up
                    ...
                    view.findNavController()
                        .navigate(R.id.action_signalementFormEnfantFragment_to_signalementFormInfosFragment)
                }
            }
